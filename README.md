...
Usa **+ Crear** o el **+** de una rama para crear épicas, features, historias, tareas y bugs en local. Los elementos nuevos y editados se señalan como pendientes; el paso 3 muestra el total. Los títulos también se pueden editar. Las creaciones se envían después de revisar, con los padres antes que los hijos.
